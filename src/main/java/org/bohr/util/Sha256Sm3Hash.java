...
public class Sha256Sm3Hash implements Serializable, Comparable<Sha256Sm3Hash> {
  ...
  public static final org.bohr.util.Sha256Sm3Hash ZERO_HASH = wrap(new byte[LENGTH]);
  ...
  public Sha256Sm3Hash(long num, org.bohr.util.Sha256Sm3Hash hash) {
    byte[] rawHashBytes = this.generateBlockId(num, hash);
    //checkArgument(rawHashBytes.length == LENGTH);
    this.bytes = rawHashBytes;
  }
  ...
  public static org.bohr.util.Sha256Sm3Hash wrap(byte[] rawHashBytes) {
    return new org.bohr.util.Sha256Sm3Hash(rawHashBytes);
  }

  public static org.bohr.util.Sha256Sm3Hash wrap(ByteString rawHashByteString) {
   ...
   */
  @Deprecated
  public static org.bohr.util.Sha256Sm3Hash create(byte[] contents) {
    return of(contents);
  }
   ...
   */
  public static org.bohr.util.Sha256Sm3Hash of(byte[] contents) {
   ...
   */
  public static org.bohr.util.Sha256Sm3Hash of(File file) throws IOException {
   ...
   */
  @Deprecated
  public static org.bohr.util.Sha256Sm3Hash createDouble(byte[] contents) {
   ...
   */
  public static org.bohr.util.Sha256Sm3Hash twiceOf(byte[] contents) {
  ...
  private byte[] generateBlockId(long blockNum, org.bohr.util.Sha256Sm3Hash blockHash) {
  ...
  public boolean equals(Object o) {
    ...
    if (o == null || !(o instanceof org.bohr.util.Sha256Sm3Hash)) {
      return false;
    }
    return Arrays.equals(bytes, ((org.bohr.util.Sha256Sm3Hash) o).bytes);
  }
  ...
  @Override
  public int compareTo(final org.bohr.util.Sha256Sm3Hash other) {
