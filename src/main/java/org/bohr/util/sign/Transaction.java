 ...
 */
package org.bohr.util.sign;

import org.apache.commons.lang3.builder.EqualsBuilder;
import org.apache.commons.lang3.builder.HashCodeBuilder;
import org.bohr.util.Amount;
import org.bohr.util.sign.crypto.Hash;
...
public class Transaction {
    ...
    private final Amount gasPrice; // nanoBohr per gas
    ...
    private Transaction(byte[] hash, byte[] encoded, byte[] signature) {
        ...
        this.signature = Key.Signature.fromBytes(signature);
    }
